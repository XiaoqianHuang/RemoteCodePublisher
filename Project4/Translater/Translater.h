...
* ----------------------
*  ver 2.0 : 4/30/2018
*  - modify to implement the functionalities to set save path
*  ver 1.0 : 3/27/2018
*  - first release
*/
...
namespace MsgPassingCommunication
{
  ...
  public:
    Translater();
    void listen(CsEndPoint^ ep, String^ path);
  ...
  void Translater::listen(CsEndPoint^ ep,String^ path)
  {
